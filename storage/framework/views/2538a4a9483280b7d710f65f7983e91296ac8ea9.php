    ...
    <div class="row">
        <div class="col-6">
            <ul class="list-unstyled mt-4">
                <li>
                    <a class="d-flex justify-content-between" href="<?php echo e(route('frontend.rss.detail', ['alias'=> 'tin-moi-nhat.rss'])); ?>">
                        Tin mới nhất
                        <span class="d-flex">
                            RSS
                            <div class="wrap-img">
                ...
                <li class="mt-3">
                    <a class="d-flex justify-content-between" href="<?php echo e(route('frontend.rss.detail', ['alias'=> 'tin-xem-nhieu.rss'])); ?>">
                        Tin xem nhiều
                        <span class="d-flex">
                            RSS
                            <div class="wrap-img">
                ...
                <?php if(isset($menus)): ?>
                    <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($item->parent_id == $main_menu->id): ?>
                            <li class="mt-3">
                                <a class="d-flex justify-content-between" href="<?php echo e(route('frontend.rss.detail', ['alias'=> $item->url_link.'.rss'])); ?>">
