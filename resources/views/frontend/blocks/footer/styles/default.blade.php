    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="certificate-container">
          <a href="#"
            ><img src="{{ asset('themes/frontend/f4web/images/sys_basic_2x.png')}}" alt="Chứng chỉ"
          /></a>
          <a href="#"
            ><img src="{{ asset('themes/frontend/f4web/images/DMCA-01.png')}}" alt="Chứng chỉ"
          /></a>
          <a href="#"
            ><img src="{{ asset('themes/frontend/f4web/images/bo-cong-thuong.png')}}" alt="Chứng chỉ"
          /></a>
        </div>
